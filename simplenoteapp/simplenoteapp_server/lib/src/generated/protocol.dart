...
import 'package:simplenoteapp_server/src/generated/notes.dart' as _i5;
import 'package:serverpod/protocol.dart' as _i6;
export 'example.dart';
export 'notes.dart';
export 'response.dart'; // ignore_for_file: equal_keys_in_map
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.Response) {
      return _i4.Response.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i4.Response?>()) {
      return (data != null ? _i4.Response.fromJson(data, this) : null) as T;
    }
    if (t == List<_i5.Note>) {
